    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#020617] flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="mt-1.5 text-sm text-slate-500 dark:text-slate-400 font-medium text-center">
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-1">
                  ...
                  <Link href="/forgot-password" className="text-xs font-bold text-indigo-600 hover:underline underline-offset-4">
                    Forgot Password?
                  </Link>
                </div>
                <div className="relative group">
              ...
              <button
                type="submit"
                disabled={loading}
                className={cn(formButtonPrimaryClass, "group")}
              >
                {loading ? (
                  <>
